...
const LeaveRequest = () => {
  ...
  const handleApplyButtonClick = () => {
    if (!leaveType) {
      ...
      (!otherFromDate || !otherToDate || !otherReason.trim())
    ) {
      ...
      (!selectedDate || !timeSlot || !reason.trim())
    ) {
      ...
      if (
        ...
        const month = String(formattedSelectedDate.getMonth() + 1).padStart(
          2,
          '0'
        );
                ...
                <div>
                  ...
                  <div className="mb-2">
                    <label className="inline-flex items-center">
                      ...
                      />
                      <span className="ml-2 font-poppins text-sm">
                        Forenoon
                      </span>
                    </label>
                    <label className="inline-flex items-center ml-4">
